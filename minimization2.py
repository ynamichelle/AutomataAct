...
def dfa_minimization_joan():
    ...
    print("==================================================")
    print("       DFA MINIMIZATION (STATES: J - O - A - N)   ")
    print("==================================================")
    ...
    # Preserve order so J and A merge into 'JA'
    state_to_name = {
    ...
    def test_string(bitstring, label):
        ...
        print(f"{label:<12} | Input: '{bitstring:<7}' -> Path: {' -> '.join(path):<24} | {mark} {status}")

    print("\n--- STRING VERIFICATION ---")
    test_string("01",      "Accepted 1")
    test_string("101",     "Accepted 2")
    test_string("00",      "Rejected 1")
    test_string("010",     "Rejected 2")


dfa_minimization_joan()